...
-- Inserir clientes (created_at e updated_at são preenchidos automaticamente)
...
-- Inserir logs (usando NOW() para MySQL/PostgreSQL ou GETDATE() para SQL Server)
-- Nota: O script precisa ser adaptado para cada SGBD específico
